...
MAX_LENGTH_VERSION_STRING     = int(18)    # Maximum length of a version string: 17 characters + terminator
...
class PCANBasic:
    ...
    def GetValue(
        ...
        """        
        try:
            if Parameter == PCAN_API_VERSION or Parameter == PCAN_HARDWARE_NAME or Parameter == PCAN_CHANNEL_VERSION or Parameter == PCAN_LOG_LOCATION or Parameter == PCAN_TRACE_LOCATION or Parameter == PCAN_BITRATE_INFO_FD or Parameter == PCAN_IP_ADDRESS or Parameter == PCAN_FIRMWARE_VERSION:
